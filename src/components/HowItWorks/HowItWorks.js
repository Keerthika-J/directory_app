  ...
  return (
    <div class="how-it-works">
        <div class="py-8 gray-section bg-secondary">
            <div class="border-b border-borders">
                <div class="how-it-works-heading">
                    <span class="text-2xl md:text-4xl">How It Works</span>
                </div>
            </div>
            <div class="how-it-works-grid grid grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-8 lg:gap-y-28 ">
               <img src={require("D:/KODEON/Repositories/directory_app/src/components/images/how-it-works-img.png")} alt="how-it-works-img.png" class="w-full h-full object-cover"></img> 
               <div class="w-full text-center lg:text-left flex flex-col justify-evenly float-right my-8">
                    ...
                    <button class="w-full  add-business-button bg-primary">Add Business</button>
                    <button class="w-full  start-search-button bg-primary mt-6 lg:mt-0 lg:mx-8">Start Search</button>
                    </div>
                </div>
                <div class="">
                ...
                <div class="white-cards">
                    <div class="card-1 bg-white border border-borders bg-white border border-borders w-full h-3/4 md:h-1/4">
                       <div class="numbers-circle-1-2-3 bg-primary ">
                    ...
                    <div class="card-1 bg-white border border-borders bg-white border border-borders w-full lg:w-10/12 h-3/4 md:h-1/4 my-4">
                        <div class="numbers-circle-1-2-3 bg-primary">
        ...
        <div class="subscription-payment-grid bg-white grid grid-cols-1 md:grid-cols-2 gap-20 ">
