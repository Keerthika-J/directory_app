...
export default function ContactUs() 
{
  return (
    <div class="contact-us-page">
        <div class="">
            <div class="contact-heading py-4 border-b border-[#e0e0e0] px-4 md:px-8 lg:px-44">
                <span class="text-2xl md:text-4xl">Contact</span>
            </div>
            <div class="lets-talk-section flex flex-col lg:flex-row px-4 md:px-8 lg:px-44">
                <img src={require("C:/Users/91950/directory_app/src/components/images/contact-img.jpg")} class="lets-talk-img w-full lg:w-7/12"></img>
                <div class="lg:ml-12">
                    <span class="block text-sm font-bold text-yellow mt-8 mb-4">LET'S TALK</span>
            ...
            <div class="send-mail-outer-div px-4 md:px-8 lg:px-44">
                <div class="send-mail-section px-8 flex flex-col lg:flex-row">
