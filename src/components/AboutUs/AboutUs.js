  ...
  return (
    <div class="about-us-page">
        <div class="py-8 bg-[#fafafb]">
            <div class="about-heading pb-8 border-b border-[#e0e0e0] px-4 md:px-8 lg:px-44">
                <span class="text-2xl md:text-4xl">About Us</span>
            </div>
            <div class="about-us-grid grid grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-8 lg:gap-y-28 px-4 md:px-8 lg:px-44">
                <img src={require("C:/Users/91950/directory_app/src/components/images/contact-img.jpg")} class="about-us-img w-full h-full object-cover"></img>
                <div class="">
                    ...
                    <div class="my-6 flex justify-between">
                        <div class="">
                            <span class="block text-3xl font-bold text-yellow">50,000</span>
                ...
                <img src={require("C:/Users/91950/directory_app/src/components/images/about-us-row-2-img.png")} class="about-us-img w-full h-full object-cover"></img>
            </div>
        </div>
        <div class="quick-to-install flex flex-col md:flex-row justify-between px-4 md:px-8 lg:px-44">
            <img src={require("C:/Users/91950/directory_app/src/components/images/quick-to-install-img.png")} class="quick-to-install-img w-full md:w-2/5 h-2/4 object-cover"></img>
            <div class="lg:w-2/5 text-center lg:text-left flex flex-col justify-evenly items-center float-right">
                ...
                <button class="w-full md:w-[300px] get-started-now-button my-6">Get Started Now!</button>
            </div>
        </div>
    </div>
  )
